package com.plusmobileapps.sharedcode.redux.presentermiddleware
...
// {a:Any,b:Any -> a===b}
fun <T> computationMemoizer(computeFn: (Array<out Any>) -> T) = object :
    Memoizer<T> {
 ...
 */
fun <T> singleInputMemoizer(func: (Array<out Any>) -> T)=object:
    Memoizer<T> {
 ...
 */
abstract class AbstractSelector<S, O> :
    Selector<S, O> {
...
class SelectorForP4<S:Any, I0 : Any, I1 : Any, I2 : Any, I3 : Any>(@JvmField val si0: SelectorInput<S, I0>,
    ...
    fun<I4 : Any> withField(fn: S.() -> I4) =
        SelectorForP5<S, I0, I1, I2, I3, I4>(
            si0,
            si1,
            si2,
            si3,
    ...
    fun<I4 : Any> withFieldByValue(fn: S.() -> I4) =
        SelectorForP5<S, I0, I1, I2, I3, I4>(
            si0,
            si1,
            si2,
    ...
    fun<I4 : Any> withSelector(si: SelectorInput<S, I4>) =
        SelectorForP5<S, I0, I1, I2, I3, I4>(
            si0,
            si1,
            si2,
...
class SelectorForP3<S:Any, I0 : Any, I1 : Any, I2 : Any>(@JvmField val si0: SelectorInput<S, I0>,
    ...
    fun<I3 : Any> withFieldByValue(fn: S.() -> I3) =
        SelectorForP4(
            si0,
            si1,
            si2,
    ...
    fun<I3 : Any> withSelector(si: SelectorInput<S, I3>) =
...
class SelectorForP2<S:Any, I0 : Any, I1 : Any>(@JvmField val si0: SelectorInput<S, I0>,
    ...
    fun<I2 : Any> withField(fn: S.() -> I2) =
        SelectorForP3<S, I0, I1, I2>(
            si0,
            si1,
            InputField(
                fn,
    ...
    fun<I2 : Any> withFieldByValue(fn: S.() -> I2) =
        SelectorForP3<S, I0, I1, I2>(
            si0,
            si1,
            InputField(
    ...
    fun<I2 : Any> withSelector(si: SelectorInput<S, I2>) =
        SelectorForP3<S, I0, I1, I2>(
            si0,
            si1,
            si
...
class SelectorForP1<S:Any, I0 : Any>(@JvmField val si0: SelectorInput<S, I0>) {
    fun<I1 : Any> withField(fn: S.() -> I1) =
        SelectorForP2<S, I0, I1>(
            si0,
            InputField(
                fn,
                byRefEqualityCheck
    ...
    fun<I1 : Any> withFieldByValue(fn: S.() -> I1) =
        SelectorForP2<S, I0, I1>(
            si0,
            InputField(
                fn,
    ...
    fun<I1 : Any> withSelector(si: SelectorInput<S, I1>) =
        SelectorForP2<S, I0, I1>(si0, si)
...
class SelectorBuilder<S:Any> {
    ...
    fun<I0 : Any> withFieldByValue(fn: S.() -> I0) =
        SelectorForP1<S, I0>(
            InputField(
                fn,
                byValEqualityCheck
    ...
    fun<I0 : Any> withSelector(si: SelectorInput<S, I0>) =
        SelectorForP1<S, I0>(si)
